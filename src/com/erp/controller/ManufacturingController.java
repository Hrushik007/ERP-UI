...
public class ManufacturingController {
    ...
    public void recordExecutionLog(Component owner, String orderId, String note, Runnable after) {
        Map<String, Object> p = new HashMap<>();
        p.put("orderId", orderId); p.put("note", note);
        submit(owner,
                () -> ui.sendData(ManufacturingEndpoints.MFG_EXECUTION_LOG, p, String.class),
                ok -> { if (after != null) after.run(); },
                () -> recordExecutionLog(owner, orderId, note, after));
    }
