...
public class ManufacturingDashboardTab extends JPanel
    ...
    @Override public void onStatsLoaded(Map<String, Integer> s) {
        cars.setValue(String.valueOf(s.getOrDefault("cars", 0)));
        pending.setValue(String.valueOf(s.getOrDefault("pendingOrders", 0)));
        inProg.setValue(String.valueOf(s.getOrDefault("inProgress", 0)));
        completed.setValue(String.valueOf(s.getOrDefault("completed", 0)));
        qcFail.setValue(String.valueOf(s.getOrDefault("qcFails", 0)));
    }
